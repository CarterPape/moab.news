...
{% include authoring/attributed_quote.html
    quote = quote
    by =    "Bradia Holmes, education coordinator, Moab Valley Multicultural Center; June 8, 2021"
%}
...
{% include authoring/captioned_image.html
    image_name = "four_corners/IMG_2226.JPG"
...
{% include authoring/captioned_image.html
    ...
    caption = "These vehicles collided Wednesday afternoon, June 9. All passengers suffered only minor injuries."
...
{% include authoring/captioned_image.html
    image_name = "water_report/water_availability.png"
    class = "torn-paper"
