...
- [In-depth on the 2017 housing plan](https://web.archive.org/web/20201229100342/https://www.moabhousingplan.com/)[^insecure-link]
...
[^insecure-link]: The [original link](https://www.moabhousingplan.com/index.html){:data-proofer-ignore="true"} yields a bad [SSL certificate](https://www.cloudflare.com/learning/ssl/what-is-an-ssl-certificate/){:data-proofer-ignore="true"}, which means I can't properly crawl it. I have provided an archived version of the page instead.
